       ...
       private void DataGridView_RowPostPaint(object sender, DataGridViewRowPostPaintEventArgs e)
        ...
        private void DataGridView_CellMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
          ...
          //  categoryNameTextBox.Text = DataGridView.Rows[e.RowIndex].Cells[1].Value.ToString();
            ...
            CategorySaveButton.Visible = false;

        }

        private void DataGridView_CellEndEdit(object sender, DataGridViewCellEventArgs e)
        {
            category.CategoryName = DataGridView.Rows[e.RowIndex].Cells[1].Value.ToString();
            // click and show on text box
            /*
            categoryNameTextBox.Text = DataGridView.Rows[e.RowIndex].Cells[1].Value.ToString();
           category.CategoryName = categoryNameTextBox.Text;
           */
        ...
        {
            CategorySaveButton.Visible = true;
        }
